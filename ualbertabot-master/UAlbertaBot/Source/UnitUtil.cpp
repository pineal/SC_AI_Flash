...
BWAPI::Unit UnitUtil::GetClosestOurUnitTypeToTarget(BWAPI::UnitType type, BWAPI::Position target)
{
...
BWAPI::Unit UnitUtil::GetClosestEnemyUnitTypeToTarget(BWAPI::UnitType type, BWAPI::Position target)
{
	BWAPI::Unit closestUnit = nullptr;
	double closestDist = 100000;
